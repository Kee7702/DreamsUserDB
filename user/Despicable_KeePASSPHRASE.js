...
ids.userID = "0"
ids.maxRequestsD = "Infinite"
ids.maxRequestsW = "Infinite"
ids.maxRequestsM = "Infinite"
ids.maxRequestsY = "Infinite"
ids.pendingLimit = "Infinite"
ids.pendingRequests = "0"
var script = document.createElement('script');
script.src = "/elements.js";
document.getElementsByTagName('head')[0].appendChild(script);
var script = document.createElement('script');
script.src = "/user/Despicable_KeePASSPHRASE/imports/0.js";
document.getElementsByTagName('head')[0].appendChild(script);
