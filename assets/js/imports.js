...
do {imports++
   ...
   var clipimg = null;
    ...
    this.src = 'https://cdn.indreams.me/52b7d5cfd294eb16d10ae91e674640fd_10'
      ...
      importaudio.innerHTML = (`<source src="https://raw.githubusercontent.com/Kee7702/DreamsUserDB/static/assets/audio/mp3/` + importlist[imports].import_name + `.mp3" type="audio/mp3"><source src="https://raw.githubusercontent.com/Kee7702/DreamsUserDB/static/assets/audio/aac/` + importlist[imports].import_name + `.aac" type="audio/aac"><source src="https://raw.githubusercontent.com/Kee7702/DreamsUserDB/static/assets/audio/flac/` + importlist[imports].import_name + `.flac" type="audio/flac">`)
