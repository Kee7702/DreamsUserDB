...
(async()=>{
    ...
    (async()=>{
        ...
        !params.get("id") && !params.get("name")) {
            ...
            do {
                imports++,
                document.getElementById("audioClips").innerHTML += `<div style="margin:4px;padding:10px;display:inline-grid;text-align:center;background:${importlist[imports].img[0].color || '#333'};border-radius:10px;max-width:calc(100% - 28px);width:480px">
  ...
  ${importlist[imports].source && '<div style="height:54px;margin-top:24px;display:flex"><audio src="https://audio.dreams.kee7702.tk/' + importlist[imports].source + '.mp3" controls="" preload="none" loop="" style="width:100%;margin:0;border-radius:10px;align-self:flex-end;max-height:44px"></audio></div>' || importlist[imports].sound_id && '<div style="height:54px;margin-top:24px;display:flex"><audio src="https://audio.dreams.kee7702.tk/' + importlist[imports].sound_id.replaceAll('-', '/') + '.ogg" controls="" preload="none" loop="" style="width:100%;margin:0;border-radius:10px;align-self:flex-end;max-height:44px"></audio></div>' || '<div style="height:54px;margin-top:24px;display:flex"><a style="padding:12px;background:#fff2;font-size:16px;line-height:20px;color:#ccc;font-family:Poppins;border-radius:16px;height:20px;align-self:flex-end;margin:0;width:100%">No Audio File</a></div>'}
</div>`
