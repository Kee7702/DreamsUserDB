...
(async()=>{
  ...
  <img class="global-post-icon" src="https://cdn-prod.puprod.indreams.me/${userdb[importlist[imports].userID].imphash}_10" style="height: 20px; width: 20px; line-height: 20px; transform: scale(2) rotate(-5deg);">
